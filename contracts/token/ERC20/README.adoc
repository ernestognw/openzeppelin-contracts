...
* {ERC3643}: institutional grade security token standard (T-REX) providing compliance-driven transfers with identity verification, freezing capabilities, and regulatory controls (standardized as ERC-3643).
